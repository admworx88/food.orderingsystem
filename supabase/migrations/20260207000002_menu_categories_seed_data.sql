-- Migration: Comprehensive menu categories seed data
-- Reference: Standard restaurant categories + Filipino cuisine for hotel restaurant

-- Clear existing categories (if any) and insert comprehensive list
...
--   'breakfast', 'all-day-breakfast', 'silog-meals', 'filipino-favorites',
--   'grilled-bbq', 'appetizers', 'soups', 'salads', 'rice-meals', 'chicken',
--   'pork', 'beef', 'seafood', 'pasta-noodles', 'vegetarian', 'side-dishes',
--   'rice-varieties', 'extra-toppings', 'hot-beverages', 'cold-beverages',
--   'fresh-juices', 'soft-drinks', 'desserts', 'filipino-desserts', 'ice-cream',
--   'chefs-specials', 'seasonal-items', 'kids-menu', 'healthy-options',
